...
echo ""
echo "To create a Cloud Scheduler job that runs on the 1st of every month:"
echo "=================================================================="
echo ""
